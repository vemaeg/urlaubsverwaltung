...
public class VacationLengthResponse {
    ...
    VacationLengthResponse(BigDecimal vacationDaysLeft, BigDecimal previousYearRemainingDays, BigDecimal vacationDaysAllowed, Map<Integer, VacationDays> vacationDays, Person person) {
